...
import kfp
from pipeline import test_component_pipeline
...
# %%
kfp.compiler.Compiler().compile(test_component_pipeline, PIPELINE_SPEC_FILE)

# %%
job = aiplatform.PipelineJob(
    display_name="python-containerized-test",
    template_path=PIPELINE_SPEC_FILE,
    pipeline_root="gs://cvs_demo_bucket",
    parameter_values={"config": user_config.get("config")},
